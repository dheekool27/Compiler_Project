...
public class ScannerTest {
	...
	public void failedTest1() throws LexicalException {
		...
		checkNext(scanner, OP_COLON, 3, 1, 1, 4);
		checkNext(scanner, IDENTIFIER, 4, 4, 1, 5);
		checkNext(scanner, COMMA, 8, 1, 1, 9);
		checkNext(scanner, IDENTIFIER, 10, 4, 2, 1);
		checkNext(scanner, SEMI, 14, 1, 2, 5);
		checkNextIsEOF(scanner);
	}
	
	
	@Test
	public void failedTest2() throws LexicalException {
	...
	@Test
	public void testTermination() throws LexicalException {
		String input = "\0";
		show(input);
	...
	@Test
	public void testSlash() throws LexicalException {
		String input = "/";
		Scanner scanner = new Scanner(input).scan();
		show(input);
		show(scanner);
	...
	public void IdentifierTest() throws LexicalException {
		String input = "abcde _q1_ q1 _1 1x";
		Scanner scanner = new Scanner(input).scan();
		show(input);
		show(scanner);
		...
		checkNext(scanner, KW_x, 18, 1, 1, 19);
		checkNextIsEOF(scanner);
	}
	...
	@Test
	public void stringLiteralTestError() throws LexicalException {
		String input = "\"qwer\\pty\"";
		show(input);
		thrown.expect(LexicalException.class);
		try {
			new Scanner(input).scan();
